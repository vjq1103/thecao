            ...
            <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                      ...
                      @endif
                                ...
                                <form action="{{ route('xlNaptructiepcham') }}" method="POST" >
                                  @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select class="form-control" name="card_type" id="card_type" class="" required onchange="checkCardType(this)">
                                                ...
                                                @foreach ($card as $value)
                                                    <option value="{{ $value->card_code }}">{{ $value->card_name }} ({{ $value->ckcham }}%)</option>
                                                @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <input type="number" name="card_pin" placeholder="Nhập vào mã thẻ" class="form-control" maxlength="18"  minlength="10" required>
                                    </div>
                                    <div class="form-group row">
