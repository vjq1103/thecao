...
<head>
    ...
    <title>Nạp thẻ cào tự động - đổi thẻ trực tiếp lên nhà mạng - Đổi thẻ cào qua mã nhúng</title>
                                ...
                                <form action="{{ route('frame.createPayment') }}" method="POST" >
                                  @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control" value="" placeholder="Số điện thoại của bạn" name="phone" required maxlength="15">
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <select required class="form-control" name="card_price" id="card_price">
                                              ...
                                              <!--<option value="1000000" disabled>1000K</option>-->
                                           </select>
                                    </div>
                                    <div class="form-group row">
				...
				<!--<h6 class="text-center">Lấy kết quả & Nạp thẻ</h6>-->
                  ...
                  <div class="col-md-12 col-xs-12 col-sm-12">
                    <br>
						...
						<CODE style="display:none;">Nhâp số điện thoại để kiểm tra kết quả và thông tin khác</CODE>
