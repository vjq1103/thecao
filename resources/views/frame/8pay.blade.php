...
<head>
    ...
    <link href="//8pay.pro/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <script src="//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <!-- Custom fonts for this template-->
    <link href="//8pay.pro/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Page level plugin CSS-->
    <link href="//8pay.pro/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">


    <!-- Custom styles for this template-->
    <link href="//8pay.pro/css/sb-admin.css" rel="stylesheet">
    <link href="//8pay.pro/css/style.css" rel="stylesheet">
            ...
            <div class="row">
					...
					@endif	
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control" value="" placeholder="Nhập số điện thoại bạn đúng cấu trúc 098xxxx" name="phone" required maxlength="15">
                                    </div>
                                    <div class="form-group row">
				...
				<!--<h6 class="text-center">Lấy kết quả & Nạp thẻ</h6>-->
					...
					@endif								
						<!-- Hien ket qua -->
								...
								<div class="form-item">
								<code>Lưu ý: Chọn sai mệnh giá hoặc nhập sai nhiều lần có thể mất thẻ</code><br/>
				
                                    <button class="btn btn-success" style="border:#fff 1px; border-radius:2px;color:{{ $result->color }};background-color:{{ $result->background }}">
